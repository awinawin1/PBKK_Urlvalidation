...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block"> 
        <?php if ($this->session->get('user-name') == null) { ?>
        <a href="/dashboard/auth/register" class="nav-link">register</a>
        <?php } ?>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard,Selamat Datang <?= $this->session->get('user-name') ?></h1>
    ...
    <div class="row">
       ...
       Keterangan :<br> <?= $barang['keterangan'] ?>
        <br>
        <a href="/dashboard/upload/edit/<?= $barang['id'] ?>"><button class="btn btn-outline-primary">Edit</button></a>
